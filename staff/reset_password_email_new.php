...
<div class="card login-form">
	<div class="card-body">
		...
		<form role="form" method="post" action="../model/reset_password_email_new.php" id="myForm1" class="needs-validation" novalidate>
    <?php
		...
		<div class="form-group">
           New Password<input type="text" id="pwdId" name="password" class="form-control" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required>
