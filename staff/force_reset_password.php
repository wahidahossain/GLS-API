...
<head>
  ...
  <title>JRP Insights | Password Reset</title>
...
<div class="card login-form">
  ...
  <form role="form" action="../model/force_reset_password.php" name=form1 id="myForm1" class="needs-validation" novalidate>
    ...
    ?>
        ...
        <div class="form-group">
            ...
            <div id="pwdIdInvalid" class="invalid-feedback">** at least one number and one uppercase and lowercase letter, and at least 8 or more characters</div>
