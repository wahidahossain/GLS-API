        ...
        <div class="row">        
            <div class="col-md-2">
                <div class="card-body box-profile">
                    ...
                    <img class="profile-user-img img-fluid img-circle" src="../index/delivery-truck.png" alt="User profile picture">
                    </div>
                    <h3 class="profile-username text-center">Parcel</h3>              
            ...
            <div class="col-md-2">
                <div class="card-body box-profile">
                    <div class="text-center">
                    <img class="profile-user-img img-fluid img-circle" src="../index/air-freight.png" alt="User profile picture">
                    </div>
                    <h3 class="profile-username text-center">Freight</h3>               
         ...
         <!-- /col-md-3 -->
          <div class="col-md-2">
                <div class="card-body box-profile">
                    <div class="text-center">
                    <img class="profile-user-img img-fluid img-circle" src="../index/checklist.png" alt="User profile picture">
                    </div>
