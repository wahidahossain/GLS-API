                            ...
                            <div class="" id='dRequestReturnLabel'>                           
                               ...
                               <div class="card card-body" id='yes_requestReturnLabel' style='display:none;'> 
                                ...
                                <tr>
                                    ...
                                    <th><span class="required">Qty</span></th>
                                    <th><span class="required">Weight</span></th>
                                ...
                                <tr>
                                    <td  id="col0">
                                    <select name="parcelTypeParcelCanada[]" required>    
                                    <option value="">Select Option</option>
                                    <option value="Box" selected>Box</option>                                       
                                    <option value="Envelope">Envelope</option>
                                    </select></td>
                                    <td  id="col1"><input name="quantity[]" id="quantity" type="number" class="form-control" size="5" oninput="this.value = Math.round(this.value);" required></td>
                                    <td  id="col2"><input name="weight[]" id="weight" type=number step=0.01 class="form-control" size="5" required></td>
                                    <td  id="col3"><input name="length[]" id="length" type=number step=0.01 class="form-control" size="5" required></td>
                                    <td  id="col4"><input name="width[]" id="width" type=number step=0.01 class="form-control" size="5" required></td>
                                    <td  id="col5"><input name="depth[]" id="depth" type=number step=0.01 class="form-control" size="5" required></td>
                                    </tr>
                                    </table> 
                                    <table> 
                                        <tr> 
                                ...
                                <div class="form-group">
                                    ...
                                    <div id='surcharges_type_parcel' style="padding:0px 0px 0px 5px;">
                                        <select class="custom-select" name="surcharges_type_parcel" id='select_surcharges1' onchange='selectSurcharges1()' required>
                                            ...
                                            <option value="PHD">PHDS | Residential Delivery Signature</option>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="bootstrap-timepicker">
                                            <div class="form-group">
                                                    ...
                                                    <code>Has to be on a business day</code>                                                 
                                                        <label>Ready At (Time)</label>                        
                                                        <?php
