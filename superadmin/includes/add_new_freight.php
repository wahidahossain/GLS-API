                          ...
                          <div class="card card-primary">
                            ...
                            <div class="form-group" style='display:none;'>
                                ...
                                <div class="tabMobile">
                                    ...
                                    <tr>
                                        <td  id="col0">
                                        <select name="parcelTypeFreight[]" required>    
                                        <option value="">Select Option</option>
                                        ...
                                        <td  id="col2"><input name="weight[]" id="weight" type=number class="form-control" step=0.01 class="" size="5" required></td>
                                        <td  id="col3"><input name="length[]" id="length" type=number class="form-control" step=0.01 class="" size="5" required></td>
                                        <td  id="col4"><input name="width[]" id="width" type=number class="form-control" step=0.01 class="" size="5"  required></td>
                                        <td  id="col5"><input name="depth[]" id="depth" type=number class="form-control" step=0.01 class="" size="5"  required></td>
                                    </tr> 
                                    </table> 
