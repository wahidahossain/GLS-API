...
//$url = 'https://smart4i.dicom.com/v1/shipment/'.$id;
...
$sql1_del_shipment ="DELETE FROM `new_shipment` WHERE `new_shipment`.`col_5` = '$col_5'; ";
...
$result2_del_tracking = mysqli_query($con, $sql1_del_tracking) or die( 'Couldnot execute query'. mysqli_error($con));
